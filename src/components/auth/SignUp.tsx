  ...
  return (
    <div className="flex flex-col items-center justify-center gap-y-8 h-screen">
      ...
      <div className="shadow-2xl space-y-7 rounded-2xl bg-white  border border-zinc-200 lg:w-1/3 md:w-1/2 min-w-[400px] py-7 px-5 ">
          <h1 className="text-3xl font-bold text-sky-800 capitalize text-center">sign up</h1>
        <div className="space-y-4 w-full">
          <div className="relative flex items-center w-full">
            <input className="px-4 h-14 pt-2 w-full outline-none ring-inset border-b-2  rounded-t-xl bg-slate-400/50 peer focus:border-sky-500 placeholder-shown:border-gray-500 border-sky-500" type="text" id="" name="name" required placeholder="" />
            <label htmlFor="name" className="absolute ms-3 capitalize text-sky-700 font-semibold text-sm scale-75 -translate-y-4 peer-focus:-translate-y-4 peer-focus:z-10 peer-placeholder-shown:z-0 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:text-sky-700 duration-300 peer-focus:scale-75  tracking-wide ">name</label>
          </div>
          <div className="relative flex items-center w-full">
          ...
          <button className="border-2 border-sky-800 hover:border-sky-800 w-full rounded-xl md:py-3 py-1.5 capitalize font-semibold text-lg text-sky-950 bg-white hover:bg-sky-800 hover:text-sky-100 cursor-pointer duration-500">sign up</button>
