    ...
    useEffect(() => {
        ...
        <div className="sticky  z-50 top-0 bg-white/50 backdrop-blur-md px-9 py-5 shadow-xl flex justify-between items-center">
            ...
            <div ref={ref} className="relative">
                ...
                <div className={`absolute bg-sky-900 p-4 right-0 mt-2 rounded-md space-y-3 ${showLogout ? "opacity-100 scale-100" : "blur-md opacity-0 scale-90"} transition-all duration-300`}>
                    <p className="capitalize text-sky-100 text-lg font-bold text-nowrap">mohamed khassar</p>
